  ...
  return (
    <section className="sub-page-section">
      ...
      <div className="terms-wrapper">
        ...
        <h1>Terms and Conditions for OrgaFarm</h1>

        <h2>Introduction</h2>

        <p>
          These Website Standard Terms and Conditions written on this webpage
          shall manage your use of our website, www.orgafarm.com accessible at
          www.orgafarm.com.
        </p>
        ...
        <p>
          Other than the content you own, under these Terms, OrgaFarm and/or its
        ...
        <p>
          ...
          and OrgaFarm may further restrict access by you to any areas of this
        ...
        <p>
          ...
          OrgaFarm a non-exclusive, worldwide irrevocable, sub licensable
        ...
        <p>
          ...
          third-party’s rights. OrgaFarm reserves the right to remove any of
        ...
        <p>
          This Website is provided "as is," with all faults, and OrgaFarm
        ...
        <p>
          In no event shall OrgaFarm, nor any of its officers, directors and
          ...
          under contract.  OrgaFarm, including its officers, directors and
        ...
        <p>
          You hereby indemnify to the fullest extent OrgaFarm from and against
        ...
        <p>
          OrgaFarm is permitted to revise these Terms at any time as it sees
        ...
        <p>
          The OrgaFarm is allowed to assign, transfer, and subcontract its
        ...
        <p>
          These Terms constitute the entire agreement between OrgaFarm and you
        ...
        <p>
          ...
          laws of the State of de, and you submit to the non-exclusive
          jurisdiction of the state and federal courts located in de for the
